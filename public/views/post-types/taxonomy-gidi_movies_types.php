 ...
 * @since      1.0.0
 */
$page_name = "Movie Type(s)";
$term_type = "gidi_movies_types";
...
.large-tab-section .gm-dropdown-content {
    min-width: 190px;
}
#myDropdown {
    min-height: 200px;
            ...
            <div class="col-md-6">
                <form action="<?php echo site_url(); ?>/movie-listings" method="get">
                    <div class="form-group">
                        <input type="text" name="genres_types_term_like" id="search-genres-field" placeholder="Search For A Movie, Genre, Movie Type">
